<?php
    ...
    if (mail($to, $subject, $body, $headers)) {
        echo "Thank you for reaching out to MVG Digital. "; // do what you want after sending the email
        $replybody = "";
        $replybody .= "Dear ".$fname." ".$lname.",\r\n\n";
        $replybody .= "Greetings! \r\n\n";
        $replybody .= "Thank you for reaching out to MVG Digital. \r\n\n"; 
